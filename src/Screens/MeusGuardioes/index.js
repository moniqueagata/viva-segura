  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.subtitulo}>Convites enviados por email para seus guardiões.</Text>
        {loading ? (
            ...
            ListEmptyComponent={
              <View style={styles.vazio}>
                <Image
                  ...
                  tintColor="#ccc"
                />
                <Text style={styles.vazioTexto}>Nenhum convite enviado ainda.</Text>
              </View>
            }
            renderItem={({ item }) => (
              <View style={styles.card}>
                ...
                <View style={styles.cardAcoes}>
                  ...
                  <Pressable style={styles.btnRemover} onPress={() => removerGuardiao(item.id_guardiao)}>
